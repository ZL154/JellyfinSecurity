...
**Hardening**
- Internal hardening pass on the auth pipeline: cookie attribute handling behind reverse proxies, stricter handling of forwarded headers, additional input bounds on auth endpoints, tightened token binding.
